...
var createCatalogMemberFromType = function(type, terria) {
    ...
    if (!defined(Constructor)) {
        throw new TerriaError({
            title: 'Unsupported catalog item type',
            message: '\
Unknown catalog item type: ' + type + '.  If you are loading your own catalog, please verify that it is correct. \
This error may also indicate an attempt to load a newer catalog file in an older version of '+terria.appName+'.'
        });
    }
