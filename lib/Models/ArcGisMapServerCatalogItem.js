...
var ArcGisMapServerCatalogItem = function(terria) {
    ...
    /**
     * Gets or sets the map defining what properties from the server should be displayed when identify is called.
     * If undefined all properties are displayed.
     * @type {Object}
     */
    this.identifyPropertyMap = undefined;
...
ArcGisMapServerCatalogItem.prototype._createImageryProvider = function() {
    ...
    var imageryProvider = new ArcGisMapServerImageryProvider({
        ...
        identifyPropertyMap: this.identifyPropertyMap
    });
