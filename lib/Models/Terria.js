        ...
        return loadJson5(terria.corsProxy.getURLProxyIfNecessary(source))
            ...
            .otherwise(function () {
                terria.error.raiseEvent({
                    ...
                    message: 'An error occurred while loading initialization information.  This may indicate that you followed an invalid link or that there is a problem with your Internet connection.'
                });
                return undefined;
            });
    } else {
